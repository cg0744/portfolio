        ...
        <div className="row gy-5">
          ...
          <div className="col-lg-7 pe-lg-5">
            ...
            <p className="text-muted mb-4" style={{ fontSize: '1.05rem', lineHeight: '1.7' }}>
              Recently, I've been expanding my technical horizons by working on hands-on tasks like SEO optimization and AI training. Whether I'm debugging complex logic or collaborating across teams in Dutch, English, or Arabic, I love connecting the dots and solving real-world problems.
            </p>
          ...
          {/* Quick facts and tech stack grid */}
